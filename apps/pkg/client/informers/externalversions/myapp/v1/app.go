...
import (
	...
	v1 "github.com/cloudnative/summarize/apps/pkg/client/listers/myapp/v1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.MyappV1().Apps(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.MyappV1().Apps(namespace).Watch(context.TODO(), options)
			},
		},
		&myappv1.App{},
		resyncPeriod,
...
func (f *appInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&myappv1.App{}, f.defaultInformer)
}
